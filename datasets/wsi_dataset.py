...
import torch
from utils.wsi_utils import Contour_Checking_fn, isInContourV1, isInContourV2, isInContourV3_Easy, isInContourV3_Hard
...
class Wsi_Region(Dataset):
    ...
    def __init__(self, wsi_object, top_left=None, bot_right=None, level=0, 
                 ...
                 t=None, custom_downsample=1, target_patch_size=-1, use_center_shift=False):
    ...
    def __getitem__(self, idx):
        ...
        return torch.unsqueeze(patch, 0), coord, idx
