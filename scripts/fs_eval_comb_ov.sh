...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,cnv --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics dna,cnv --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics cnv,mut --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics cnv,pro --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,dna,cnv --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,cnv,mut --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,cnv,pro --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics dna,cnv,mut --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics dna,cnv,pro --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics cnv,mut,pro --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,dna,cnv,mut --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,dna,cnv,pro --selected_features --mlp_type small --max_epochs 20"
...
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics rna,cnv,mut,pro --selected_features --mlp_type small --max_epochs 20"
run_command "CUDA_VISIBLE_DEVICES=1 python main.py --gc 32 --model_type mlp --early_stopping -1 --results_dir ./results/fs_eval_comb/"$data_name"_os --data_name "$data_name"_os --omics dna,cnv,mut,pro --selected_features --mlp_type small --max_epochs 20"
